    ...
    private static function sectionSchema(): array
    {
        return [
            ...
            Textarea::make('content_json.description')->label('Description')->rows(3)
                ->visible(fn (Get $get): bool => self::typeIn($get, [PageSectionType::Cta, PageSectionType::Gallery, PageSectionType::Portfolio, PageSectionType::BlogPosts, PageSectionType::Services])),
            ...
            TextInput::make('content_json.anchor')->label('Anchor ID')
                ...
                ->regex('/^[a-z0-9-]+$/')
                ->maxLength(60)
                ->visible(fn (Get $get): bool => self::typeIn($get, [PageSectionType::Gallery, PageSectionType::Cta, PageSectionType::Testimonials, PageSectionType::Portfolio, PageSectionType::BlogPosts, PageSectionType::Services])),
            ...
            TextInput::make('content_json.limit')
                ...
                ->visible(fn (Get $get): bool => self::typeIn($get, [PageSectionType::Portfolio, PageSectionType::BlogPosts, PageSectionType::Services])),
