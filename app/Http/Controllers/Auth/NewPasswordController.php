 ...
 * already anticipates — this is the "password.reset" route it Route::has()-
 * guards for (see that method's own docblock). Uses Laravel's stock
 * password broker end to end: securely generated/hashed/expiring/single-use
 * tokens are entirely Laravel's `password_reset_tokens` table + Password
 * facade, never reimplemented here.
 */
