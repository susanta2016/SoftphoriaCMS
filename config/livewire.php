...
return [
    ...
    */
    ...
    'payload' => [
        ...
        // Raised from Livewire's default of 10 (ADMIN-006 review fix): a
        // RichEditor field inside a page-builder Repeater already sits 5
        // levels deep before its own content starts —
        // data.sections.{itemId}.content_json.body — and a Tiptap table
        // (table > tableRow > tableCell > paragraph > text, each a nested
        // "content.N" pair) adds several more on top of that. The default
        // of 10 made saving any Rich Text section containing a table throw
        // Livewire\Exceptions\MaxNestingDepthExceededException on every
        // edit to a cell (bold, links, etc.), even for a single small
        // table. 40 keeps the guard meaningful (still rejects pathological/
        // attack-crafted payloads) while giving real editor content —
        // nested lists inside table cells, tables inside blockquotes —
