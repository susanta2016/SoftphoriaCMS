<x-layouts.site :seo="$seo">
    ...
    <style>
        ...
        .auth-page form { display: grid; gap: 1rem; margin-top: 1rem; }
        .auth-page label { display: block; font-weight: 600; margin-bottom: 0.25rem; }
        .auth-page input[type="email"] { width: 100%; padding: 0.625rem; border: 1px solid #d1d5db; border-radius: 0.375rem; font: inherit; }
    ...
    <div class="auth-page">
        <main>
            ...
            <p class="auth-links"><a href="{{ route('login') }}">Back to Log In</a></p>
        </main>
    </div>
