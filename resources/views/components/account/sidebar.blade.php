@php
    ...
    $navItems = [
        ...
        [
            'route' => 'account.gratitude-journal.index',
            'label' => 'Gratitude Journal',
            'icon' => '<path d="M12 21s-7-4.5-9.5-9A5.5 5.5 0 0 1 12 6a5.5 5.5 0 0 1 9.5 6c-2.5 4.5-9.5 9-9.5 9Z" stroke-linejoin="round" stroke-linecap="round"/>',
        ],
