...
>
    ...
    <div
        ...
        @class([
            'hidden lg:hidden',
            'border-t border-white/10 bg-brand-navy' => $transparent,
            'border-t border-brand-navy/10 bg-white' => ! $transparent,
        ])
    >
            ...
            @foreach ($navItems as $label => $href)
                <a
                    ...
                    @class([
                        ...
                        'text-white/90 hover:bg-white/10 hover:text-white' => $transparent,
                        'text-brand-navy hover:bg-brand-gold/10 hover:text-brand-gold' => ! $transparent,
                    ])
                >
                    {{ $label }}
                </a>
