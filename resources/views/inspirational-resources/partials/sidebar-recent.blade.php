    ...
    <div class="rounded-2xl border border-brand-navy/10 p-6">
        ...
        <div class="mt-4 space-y-4">
            @foreach ($recent as $item)
                <a href="{{ route('inspirational-resources.show', $item) }}" class="group flex items-center gap-3">
                    <div class="h-12 w-12 shrink-0 overflow-hidden rounded-lg bg-brand-navy/10">
                        <img src="{{ $item->submitterAvatarUrl() }}" alt="" class="h-full w-full object-cover">
                    </div>
                    <div class="min-w-0">
