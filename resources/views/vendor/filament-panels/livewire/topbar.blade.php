<div class="fi-topbar-ctn">
    ...
    {{--
        Softphoria override of the package view (docs/ARCHITECTURE.md §12,
        "Navigation shell"): reorders the topbar to Logo -> collapse toggle
        -> TOPBAR_START render hook content (View Site / System Tools), and
        swaps the "expand sidebar" toggle's icon to a hamburger when the
        sidebar is collapsed, per docs/Reference UI/Admin/Admin navigation
        UI.docx. Only the ordering below differs from the upstream
        filament/filament view — keep the two in sync on package upgrades.
    --}}
